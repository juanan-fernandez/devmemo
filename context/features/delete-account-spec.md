...
**Aclaration: if the current usuer is the one with demo@devmemo.com email show an spanish message: "El usuario demo no se puede eliminar". This user can not be deleted from the db**
