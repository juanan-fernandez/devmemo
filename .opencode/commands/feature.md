...
3. Check whether tests already exist for each of them. If not, create them but create tests only when they add real value, not just for the sake of testing.
